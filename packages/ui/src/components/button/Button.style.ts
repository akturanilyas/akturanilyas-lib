...
export const button = cva(
  `flex text-center items-center justify-center backdrop-blur-md shadow-lg py-4 
   disabled:cursor-not-allowed disabled:text-slate-300 hover:bg-slate-200 duration-300 disabled:bg-slate-100`,
  {
    variants: {
      rounded: {
        sm: 'rounded',
    ...
    compoundVariants: [
      ...
      {
        variant: 'icon',
        className: ['bg-transparent', 'text-primary', 'border-2 border-primary', 'hover:bg-slate-200'],
      },
    ],
    defaultVariants: {
      size: 'medium',
